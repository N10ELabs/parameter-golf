...
def A5():
	...
	B3,A6=Ad(F.state_dict());AS=io.BytesIO();A.save(B3,AS,pickle_protocol=4,_use_new_zipfile_serialization=False);AT=AS.getvalue();B4=zlib.compress(AT,level=9);B5=b(AT)
	if l:
